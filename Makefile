...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mi. Mai 9 12:49:24 2012
...
compiler_rcc_make_all: build/qrc_nobleNote.cpp
compiler_rcc_clean:
	-$(DEL_FILE) build/qrc_nobleNote.cpp
build/qrc_nobleNote.cpp: nobleNote.qrc \
		src/icons/format-text-bold-symbolic.svg \
		src/icons/nobleNote_64x64.png \
		src/icons/format-text-italic-symbolic.svg \
		src/icons/format-text-italic-symbolic.svg
	/usr/bin/rcc -name nobleNote nobleNote.qrc -o build/qrc_nobleNote.cpp
...
build/qrc_nobleNote.o: build/qrc_nobleNote.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/qrc_nobleNote.o build/qrc_nobleNote.cpp
